		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Planning Data",
									"targetURL": "#comappcalendartableview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappcalendartableview-display": {
								"semanticObject": "comappcalendartableview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.calendartableview",
									"url": sap.ui.require.toUrl("com/app/calendartableview")
								}
							}
						}
					}
